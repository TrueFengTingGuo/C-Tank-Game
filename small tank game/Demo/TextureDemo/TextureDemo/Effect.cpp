...
Effect::Effect(glm::vec3 &entityPos, float angle, GLuint entityTexture, GLint entityNumElements) :
	GameObject(entityPos, entityTexture, entityNumElements, 4) {
...
void Effect::render(Shader& shader) {
